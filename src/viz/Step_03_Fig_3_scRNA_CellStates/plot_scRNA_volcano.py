...
DATA_PATH = Path("E:/Zika_antigravity/SC_RNA_Zika_DENV/Step06_crossmodal_validation/crossmodal_validated_progression_signature.csv")
...
def plot_volcano(df, disease, out_path):
    ...
    pub_style.save_pub_fig(plt.gcf(), out_path, dpi=300, format='tiff')
    plt.close()
    pass  # Execution logging removed for final release
