...
# Setup paths
BASE_DIR = Path("E:/Zika_Enrichment/Publication_Pipeline")
DATA_PATH = Path("E:/Zika_Enrichment/cell_state_analysis/adata_trajectory.h5ad")
FIG_DIR = BASE_DIR / "final_publication_figures"

# Add pipeline root to path so we can import pub_style
...
def main():
    ...
    print("Successfully exported all trajectory figures to final_publication_figures!")
